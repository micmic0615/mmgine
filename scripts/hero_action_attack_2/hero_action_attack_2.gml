...
if (actor_actions_enabled && my_attack_cooldown_timer_2 <= 0 && my_attack_cast_timer_1 <= 0 && my_attack_cast_timer_2 <= 0 && my_attack_cast_timer_3 <= 0){	
	...
	var bullet_max = my_attack_cooldown_timer_2 <= 0 ? (3 + my_attack_combo_2) : 1;
