...
action_shoot_bullet_explosion = argument_array[4];

action_shoot_recoil_speed = argument_array[5];
action_shoot_recoil_range = argument_array[6];

action_shoot_cast_value = argument_array[7];
action_shoot_cast_timer = 0;

action_shoot_channel_value = argument_array[8];
action_shoot_channel_timer = 0;

action_shoot_backswing_value = argument_array[9];
action_shoot_backswing_timer = 0;

action_shoot_cooldown_value = argument_array[10];
action_shoot_cooldown_timer = 0;

action_shoot_combo_max = argument_array[11];
