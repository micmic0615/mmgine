...
action_barrage[?"turn_rate_cast"] = argument_array[22];
action_barrage[?"turn_rate_channel"] = argument_array[23];

action_barrage[?"interval"] = argument_array[24];
action_barrage[?"active_angle"] = 0;

action_generic_create(action_barrage, [
	/*free_action*/ false,
	/*cast_value*/ argument_array[25],
	/*channel_value*/ argument_array[26],
	/*backswing_value*/ argument_array[27],
	/*cooldown_value*/ argument_array[28],
