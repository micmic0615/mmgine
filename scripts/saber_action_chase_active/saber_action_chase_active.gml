...
var fire_angle = angle_between(action_chase_target.x,action_chase_target.y,x,y);
var sword_angle = [action_chase_target.x + (cos(degtorad(fire_angle))*9999), action_chase_target.y + (sin(degtorad(fire_angle))*9999)]
...
if (
	...
	distance_between(x,y,action_chase_target.x, action_chase_target.y) < my_chase_jump_min_distance
){
...
if (entity_room_age_modulo(spawn_interval) && my_chase_jump_cast_timer <= 0 && my_chase_sword_disable_timer <= 0){
	...
	sword.collision_destroy_value_max = INFINITY;
