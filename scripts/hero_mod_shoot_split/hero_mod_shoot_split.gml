...
my_shoot_color = make_color_rgb(30,255,30);
...
my_shoot_bullet_explosion_radius = 50;
//my_shoot_bullet_explosion_trigger = "death";
my_shoot_bullet_chaos_speed = 160*PPS;
my_shoot_bullet_chaos_range = 200;
my_shoot_bullet_chaos_angle = 20;
